...
//Activos
router.get("/articulos", authMiddleware,verificarPermiso('Consultar_Activo'), activoController.obtenerArticulos);
router.get(
  "/articulos/:id",
  authMiddleware,
...
router.post("/articulos", authMiddleware,verificarPermiso('Crear_Activo'), activoController.crearArticulo);
router.put(
  "/articulos/:id",
  authMiddleware,
...
//Proyectos
router.post("/proyectos", authMiddleware, verificarPermiso('Crear_Proyecto'), proyectoController.crearProyecto);
router.get("/proyectos", authMiddleware, verificarPermiso('Consultar_Proyecto'), proyectoController.obtenerProyectos);
router.put(
  "/proyectos/:id",
  authMiddleware,
...
router.post(
  ...
  authMiddleware,
  verificarPermiso('Gestionar_Proyectos'),
...
//Reportes
router.get('/reportes/estado-proyectos-activos', authMiddleware, verificarPermiso('Generar_Reportes'), reporteController.obtenerReporteEstadoProyectosYActivos);
router.get('/reportes/utilizacion-activos', authMiddleware, verificarPermiso('Generar_Reportes'), reporteController.obtenerReporteUtilizacionActivos);
router.get('/reportes/estado-proyectos-activos/excel', authMiddleware, verificarPermiso('Generar_Reportes'), reporteController.exportarReporteExcel);
router.get('/reportes/estado-proyectos-activos/pdf', authMiddleware, verificarPermiso('Generar_Reportes'), reporteController.exportarReportePDF);
